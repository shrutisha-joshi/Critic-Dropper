...
<ul>
  <li><a class="activ"  style="background-color:#40E0D0" href="critic dropper.php">Home</a></li>
  ...
  <li><a class="activ" href="login.php"><?php if(isset($_POST['login_user'])){echo "Welcome".$_SESSION['username'];}?></a></li>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="https://image.tmdb.org/t/p/w1280/4anUCcqgr2qsyWQf7kPUnc3M6Fp.jpg" alt="" style="width:100%;">
      </div>

      <div class="item">
        <img src="https://image.tmdb.org/t/p/w1280/bOGkgRGdhrBYJSLpXaxhXVstddV.jpg" style="width:100%;">
      </div>
    
      <div class="item">
        <img src="https://image.tmdb.org/t/p/w1280/3P52oz9HPQWxcwHOwxtyrVV1LKi.jpg" alt="" style="width:100%;">
      </div>
    </div>
	 </div>
...
<p id="Intheatres" style="text-align:center;font-weight:bold;font-size:30px;margin:5px;">IN THEATRES WATCH NOW!!!</p><br><br>
